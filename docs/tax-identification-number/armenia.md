...
{`
{
  ...
  "@type": "TechArticle",
  "headline": "Armenia TIN number guide",
  "description": "Learn about TIN number in Armenia. Use Lookuptax for hassle-free tax id validation in Armenia and other 100+ countries",
  "keywords": "TIN, Tax ID, Armenia, find TIN",
  "author": {
    "@type": "Organization",
  ...
  "url": "https://lookuptax.com/docs/tax-identification-number/armenia-tax-id-guide"
}
`}
</JsonLd>
...
[<img src="/docs/img/posters/signup-taxid-validation5.png" alt="Sign up on Lookuptax for taxid validation"/>](https://lookuptax.com/)
