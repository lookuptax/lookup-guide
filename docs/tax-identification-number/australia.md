...
The most common reason for rejection is failing the **"Entitlement"** test. The ATO is strict about preventing employees from posing as contractors. If you cannot prove you are "carrying on an enterprise" (e.g., own your equipment, can delegate work, bear financial risk), the tool may classify you as a hobbyist or employee, making you ineligible for an ABN. <sup>[[1]](https://www.abr.gov.au/business-super-funds-charities/applying-abn/abn-entitlement)</sup>

### Do foreign directors need a Director ID?

Yes. It is now a mandatory requirement for **all** directors of Australian companies (including foreign companies registered with ASIC) to verify their identity and obtain a Director ID. Foreign directors cannot use the myGovID app and must typically apply via a paper form with certified identity documents. <sup>[[2]](https://www.abrs.gov.au/director-identification-number/apply-director-identification-number/verify-your-identity#paper-application-%E2%80%93-applicants-outside-australia)</sup>

### What if a supplier refuses to provide an ABN?

If a supplier does not provide an ABN and the transaction is for business purposes, you are legally required to withhold **47%** (the top tax rate) from the payment and send it to the ATO. However, the supplier can avoid this by providing a **"Statement by a supplier"** form if specific exceptions apply (e.g., it is a hobby or private sale). <sup>[[3]](https://www.ato.gov.au/forms-and-instructions/statement-by-supplier-not-quoting-an-abn)</sup>

### What is "Sham Contracting"?

"Sham contracting" occurs when an employer forces an employee to get an ABN and invoice them as a contractor to avoid paying entitlements like superannuation and leave. This is illegal. The ATO looks beyond the contract to the _reality_ of the relationship (control, delegation, risk) to determine the true status. <sup>[[4]](https://www.ato.gov.au/businesses-and-organisations/hiring-and-paying-your-workers/employee-or-independent-contractor/difference-between-employees-and-independent-contractors)</sup>
...
{`
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Why was my ABN application rejected?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The most common reason is failing the 'Entitlement' test. If you cannot prove you are running a business (carrying on an enterprise) rather than just being an employee or hobbyist, the ATO will reject the application."
    }
  }, {
    "@type": "Question",
    "name": "Do foreign directors need a Director ID?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, all directors of Australian companies, including foreign ones, must verify their identity and get a Director ID. Foreign residents typically need to use a paper form with certified documents."
    }
  }, {
    "@type": "Question",
    "name": "What if a supplier refuses to provide an ABN?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "If a supplier provides goods or services >$75 without an ABN, you must withhold 47% of the payment unless they provide a 'Statement by a supplier' form indicating an exception (e.g., hobby)."
    }
  }, {
    "@type": "Question",
    "name": "What is 'Sham Contracting'?",
    "acceptedAnswer": {
      "@type": "Answer",
