...
{`
{
  ...
  "@type": "TechArticle",
  "headline": "Austria TIN number guide",
  "description": "Learn about UID number in Austria. Use Lookuptax for hassle-free tax id validation in Austria and other 100+ countries",
  "keywords": "TIN, UID, Tax ID, Austri, find Firmenbuchnummer",
  "author": {
    "@type": "Organization",
  ...
  "url": "https://lookuptax.com/docs/tax-identification-number/austria-tax-id-guide"
}
`}
</JsonLd>
...
[<img src="/docs/img/posters/signup-taxid-validation8.png" alt="Sign up on Lookuptax for taxid validation"/>](https://lookuptax.com/)
