...
{`
{
  ...
  "@type": "TechArticle",
  "headline": "Aruba TIN number guide",
  "description": "Learn about persoonsnummer number in Aruba. Use Lookuptax for hassle-free tax id validation in Aruba and other 100+ countries",
  "keywords": "TIN, Tax ID, Aruba, find Persoonsnummer",
  "author": {
    "@type": "Organization",
  ...
  "url": "https://lookuptax.com/docs/tax-identification-number/aruba-tax-id-guide"
}
`}
</JsonLd>
...
[<img src="/docs/img/posters/signup-taxid-validation6.png" alt="Sign up on Lookuptax for taxid validation"/>](https://lookuptax.com/)
