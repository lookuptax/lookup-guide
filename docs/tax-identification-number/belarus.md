...
{`
{
  ...
  "@type": "TechArticle",
  "headline": "Belarus TIN number guide",
  "description": "Learn about UNP number in Belarus. Use Lookuptax for hassle-free tax id validation in Belarus and other 100+ countries",
  "keywords": "UNP, Tax ID, Belarus, Find UNP",
  "author": {
    "@type": "Organization",
  ...
  "url": "https://lookuptax.com/docs/tax-identification-number/belarus-tax-id-guide"
}
`}
</JsonLd>
...
[<img src="/docs/img/posters/signup-taxid-validation12.png" alt="Sign up on Lookuptax for taxid validation"/>](https://lookuptax.com/)
