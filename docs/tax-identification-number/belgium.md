...
{`
{
  ...
  "@type": "TechArticle",
  "headline": "Belgium TIN number guide",
  "description": "Learn about TIN number in Belgium. Use Lookuptax for hassle-free tax id validation in Belgium and other 100+ countries",
  "keywords": "TIN, Tax ID, Belgium, Find NN",
  "author": {
    "@type": "Organization",
  ...
  "url": "https://lookuptax.com/docs/tax-identification-number/belgium-tax-id-guide"
}
`}
</JsonLd>
...
[<img src="/docs/img/posters/signup-taxid-validation13.png" alt="Sign up on Lookuptax for taxid validation"/>](https://lookuptax.com/)
