...
slug: /explicadores/guia-oss-ventanilla-unica
title: Guía del One Stop Shop (OSS) - Ventanilla Única del IVA
keywords:
  [
    OSS,
    qué es OSS,
    ventanilla única IVA,
    IVA comercio electrónico UE,
    registro OSS,
    declaración OSS,
  ]
description: Guía completa sobre el VAT One Stop Shop (OSS). Aprende qué es la ventanilla única del IVA, cómo registrarte y simplificar el cumplimiento del IVA en ventas B2C dentro de la UE.
...
- [Guía VAT OSS](https://vat-one-stop-shop.ec.europa.eu/index_en)
- [Notas explicativas sobre reglas de comercio electrónico del IVA](https://vat-one-stop-shop.ec.europa.eu/system/files/2021-07/vatecommerceexplanatory_notes_28102020_en.pdf)

---

**¿Cómo puede [Lookuptax](https://lookuptax.com/) ayudarte con el cumplimiento del OSS?**
